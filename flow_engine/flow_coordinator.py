...
from .actions import (
    ActionPrompt, ActionAI, ActionQuality, ActionBuffer, ActionCache, 
    ActionNotification, ActionAnalysis, ActionConditional
)
...
class FlowCoordinator:
    ...
    def __init__(self, config_dir: Optional[str] = None):
        ...
        self.rule_engine = RuleEngine(config_dir=str(self.config_dir))
